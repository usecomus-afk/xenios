...
export default function HotelPortalDashboard() {
  ...
  return (
    <div className="space-y-6 text-zinc-100 pb-12">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-gradient-to-r from-amber-500/20 via-[#171a22] to-[#12141a] p-6 rounded-3xl border border-amber-500/30">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="text-xs text-zinc-400">{currentHotel.district}, İstanbul</span>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-2.5 shrink-0">
          <Link
            ...
            className="px-4 py-2.5 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-500 hover:to-red-600 text-white font-bold rounded-2xl text-xs flex items-center gap-1.5 shadow-lg shadow-red-600/20 transition cursor-pointer"
          >
      ...
      {/* KPI Cards: Oda Durumu, iCal/OTA, Canlı İstekler, POS Kazancı */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5">
        ...
        <div className="p-5 rounded-3xl bg-[#171a22] border border-[#2c313d] space-y-3 flex flex-col justify-between">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex flex-wrap gap-1 pt-1">
              <span className="px-2 py-0.5 rounded-lg bg-[#0f1116] border border-[#2c313d] text-[10px] text-zinc-300">Airbnb</span>
              <span className="px-2 py-0.5 rounded-lg bg-[#0f1116] border border-[#2c313d] text-[10px] text-zinc-300">Booking.com</span>
              <span className="px-2 py-0.5 rounded-lg bg-[#0f1116] border border-[#2c313d] text-[10px] text-zinc-300">Expedia</span>
              <span className="px-2 py-0.5 rounded-lg bg-[#0f1116] border border-[#2c313d] text-[10px] text-zinc-300">VRBO</span>
            </div>
          </div>
        ...
        <div className="p-5 rounded-3xl bg-[#171a22] border border-[#2c313d] space-y-3 flex flex-col justify-between">
          <div className="flex items-center justify-between text-zinc-400 text-xs">
            <span className="font-bold text-white">Otel Komisyon Payı</span>
          ...
          <div className="text-[10px] text-zinc-500 pt-1 border-t border-[#2c313d] flex items-center justify-between">
            ...
            <strong className="text-zinc-300 font-mono">Ay Sonu Havale</strong>
          </div>
        </div>
      </div>
      ...
      <div className="p-6 rounded-3xl bg-[#171a22] border border-[#2c313d] space-y-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-sm font-bold text-white">Canlı Oda Talepleri Masası ({currentHotel.name})</h3>
          </div>
          <Link
            href="/hotel-portal/requests"
        ...
        {requests.length === 0 ? (
          ...
          <div className="space-y-2.5">
            {requests.slice(0, 5).map((req) => (
              <div
                key={req.id}
                className="p-3.5 rounded-2xl bg-[#0f1116] border border-[#2c313d] flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-xs"
              >
                ...
                <div className="flex items-center gap-2 shrink-0 self-end sm:self-center">
                  ...
                  {req.status !== 'completed' && (
                    <button
                      ...
                      className="px-2.5 py-1 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg text-[10px] font-bold transition shrink-0 cursor-pointer"
                    >
                      ✓ Çözüldü
                    </button>
                  )}
